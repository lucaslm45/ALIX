...
# sad
anguloBracoDireito = 125
anguloOmbroDireito = 180

anguloBracoEsquerdo = 60
...
def moveEsquerdo():
    for i in range (anguloBracoEsquerdoNeutro, anguloBracoEsquerdo):
        kit.servo[bracoEsquerdo].angle = i
        time.sleep(velocidade)

    time.sleep(3)
    for i in range (anguloBracoEsquerdo, anguloBracoEsquerdoNeutro, -1):
        kit.servo[bracoEsquerdo].angle = i
        time.sleep(velocidade)

def moveDireito():
    for i in range (anguloBracoDireitoNeutro, anguloBracoDireito, -1):
        kit.servo[bracoDireito].angle = i
        time.sleep(velocidade)
    
    time.sleep(3)

    for i in range (anguloBracoDireito, anguloBracoDireitoNeutro):
        kit.servo[bracoDireito].angle = i
        time.sleep(velocidade)
